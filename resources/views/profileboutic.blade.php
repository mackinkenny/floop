...
@section('content')
    ...
    <section>
        <div class="container p-5">
            <div class="row">
                <div class="col-auto">
                    <img class="rounded-circle" width="150" height="150" src="/uploads/avatars/{{ $boutic->img_path }}" alt="">
                </div>
                <div class="col d-flex align-content-between flex-wrap">
                    <div class="col-12">
                        <div class="row p-3">
                            ...
                            @if(Auth::guest())
                                <form action="/login" method="GET" class="col-auto ml-auto d-flex align-items-center justify-content-center">
                                    {{ csrf_field() }}
